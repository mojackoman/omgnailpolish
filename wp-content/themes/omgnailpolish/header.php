 ...
 */
	...
	if(strlen($usebottle) > 0){
		...
		$imgbottle = $bottle_type;
	}
	if($color){
		?>
		<!-- Twitter Card data -->
		<meta name="twitter:card" value="<?php echo $cfs->get('color_notes', $id); ?>">

		<!-- Open Graph data -->
		<meta property="og:title" content="<?php echo $color[0]->post_title ?>" />
		<meta property="og:type" content="article" />
		<meta property="og:url" content="<?php echo wp_get_shortlink($id); ?>" />
		<meta property="og:image" content="http://omgnailpolish.com/wp-content/themes/omgnailpolish/assets/images/logo-top.png" />
		<meta property="og:description" content="<?php echo $cfs->get('color_notes', $id); ?>" />
	<?php
	}
	/* use for social media */
...
<script>
  ...
  ga('create', 'UA-50708662-1', 'omgnailpolish.com');
  ...
  <?php if ( is_page_template('nt-tools.php') || is_page_template('nt-accessories.php') || is_page_template('colors.php') || is_page_template('nt-newproductcategory.php')): ?>
				...
				<div class="sn-holder">
					...
					<div class="sn-main-holder">
						...
						<div class="snico-bx">
							...
							<a href="https://www.facebook.com/omgnailpolish"><img alt="" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sn-icon-fb.png"></a>

						</div>

						<div class="snico-bx">

							<a href="https://twitter.com/ohmygirlnails"><img alt="" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sn-icon-twit.png"></a>

						</div>

						<div class="snico-bx">

							<a href="http://instagram.com/ohmygirlnails"><img alt="" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/sn-icon-link.png"></a>
      ...
      <div class="nav-container">
        ...
        <div class="main-nav">
          ...
          <ul>
            ...
            <?php
						$identify = str_replace('-', ' ', str_replace('/','', $_SERVER['REQUEST_URI']));
						$similarity = similar_text($identify, strtolower($name), $percentage);
              $class = '';
						if($percentage > 70){
							$class = ' class="active"';
						}elseif(strtolower($name) == 'home' && $_SERVER['REQUEST_URI'] == '/'){
							$class = ' class="active"';
						}else{
							$class = '';
						}
